...
function buildIcloudHumanRecovery(
  ...
  const humanByAction = {
    "use-apple-device": {
      ...
      tipKey: "onboarding.appleRemoteIcloudHumanRecoveryUnsupportedTip",
    ...
    "enable-icloud-drive": {
      ...
      tipKey: "onboarding.appleRemoteIcloudHumanRecoveryEnableTip",
    ...
    "fix-permissions": {
      ...
      primaryCtaKey: "onboarding.appleRemoteIcloudActionEnableDrive",
      afterKey: "onboarding.appleRemoteIcloudFollowupEnableDrive",
      tipKey: "onboarding.appleRemoteIcloudHumanRecoveryPermissionsTip",
      desktopAction: "open-icloud-settings",
      phoneAction: "none",
    ...
    "export-entry": {
      ...
      tipKey: "onboarding.appleRemoteIcloudHumanRecoveryExportTip",
    ...
    "refresh-entry": {
      ...
      tipKey: "onboarding.appleRemoteIcloudHumanRecoveryRefreshTip",
    ...
    "fix-icloud-sync": {
      ...
      tipKey: "onboarding.appleRemoteIcloudHumanRecoveryFixSyncTip",
      desktopAction: "open-icloud-settings",
      phoneAction: "open-files-app-after-sync",
      showTechnicalDetails: true,
    },
    "wait-for-sync": {
      ...
      tipKey: "onboarding.appleRemoteIcloudHumanRecoveryWaitTip",
      desktopAction: "wait",
      phoneAction: "open-files-app-after-sync",
      showTechnicalDetails: false,
    },
    "open-files-app": {
      ...
      tipKey: "onboarding.appleRemoteIcloudHumanRecoveryOpenTip",
      desktopAction: "none",
