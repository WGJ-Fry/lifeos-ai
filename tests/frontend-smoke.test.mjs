...
test("production build serves desktop admin, mobile PWA, manifest, and service worker", async (t) => {
  ...
  assert.match(onboardingSource, /onboarding-icloud-open-settings/);
  assert.match(onboardingSource, /desktop\.openIcloudSettings/);
  assert.match(onboardingSource, /simpleIcloudNeedsSettings/);
  assert.match(onboardingSource, /onboarding\.simpleIcloudOpenSettings/);
  assert.match(onboardingSource, /onboarding\.icloudSettingsOpened/);
  ...
  assert.match(onboardingSource, /data-onboarding-icloud-remote-required/);
  ...
  assert.match(onboardingSource, /onboarding-icloud-quick-open-folder/);
  ...
  assert.match(onboardingAppleRemoteSource, /onboarding-icloud-desktop-one-next-cleanup/);
  assert.match(onboardingAppleRemoteSource, /onboarding-icloud-status-recovery-details/);
  ...
  assert.match(onboardingAppleRemoteSource, /desktopIcloudOneNextActionKey/);
  ...
  assert.match(onboardingAppleRemoteSource, /primaryIcloudAction\.remoteRequired/);
  ...
  assert.match(onboardingAppleRemoteSource, /icloudMonitorTriggerKeys/);
  assert.match(onboardingAppleRemoteSource, /appleRemoteIcloudMonitorTrigger/);
  assert.match(onboardingAppleRemoteSource, /appleRemoteIcloudMonitorChange/);
  ...
  assert.match(translationsSource, /清理旧入口，避免手机选错/);
  assert.match(translationsSource, /Clean old entries so the phone picks the right one/);
  assert.match(translationsSource, /高级：状态与修复记录/);
  assert.match(translationsSource, /Advanced: status and repair history/);
  ...
  assert.match(onboardingAppleRemoteSource, /latestEntryRepair/);
  ...
  assert.match(onboardingAppleRemoteSource, /compactLatestEntryRepairUrls/);
  assert.match(onboardingAppleRemoteSource, /renderLatestEntryRepairUrls/);
  ...
  assert.match(onboardingAppleRemoteSource, /nextManualItemId/);
  ...
  assert.match(onboardingAppleRemoteSource, /appleRemoteIcloudAcceptanceItemRestart/);
  assert.match(onboardingAppleRemoteSource, /appleRemoteIcloudAcceptanceItemInterruption/);
  ...
  assert.match(onboardingAppleRemoteSource, /latestEntryRepair/);
  assert.match(onboardingAppleRemoteSource, /latestEntryRepairStatusKeys/);
  assert.match(onboardingAppleRemoteSource, /latestEntryRepairActionKeys/);
  assert.match(onboardingAppleRemoteSource, /onboarding\.appleRemoteIcloudRepairStatusOld/);
  assert.match(onboardingAppleRemoteSource, /onboarding\.appleRemoteIcloudPhoneConfirmConfirmed/);
  assert.match(onboardingAppleRemoteSource, /onboarding\.appleRemoteIcloudRepairActionRefreshQr/);
  ...
  assert.match(lifeosApiSource, /latestEntryRepair/);
  assert.match(lifeosApiSource, /refresh-and-regenerate-qr/);
  assert.match(lifeosApiSource, /acceptance\?:/);
  assert.match(lifeosApiSource, /realtime-entry-ready/);
  assert.match(lifeosApiSource, /old-entry-repair/);
  ...
  assert.match(translationsSource, /能力覆盖/);
  ...
  assert.match(translationsSource, /Apple Device Acceptance/);
  assert.match(translationsSource, /离家实时入口/);
  ...
  assert.match(translationsSource, /手机刚打开的是旧入口/);
  assert.match(translationsSource, /重新生成二维码。旧二维码或旧主屏幕入口不要再用/);
  assert.match(translationsSource, /等待手机确认/);
  assert.match(translationsSource, /手机已确认打开入口/);
  assert.match(translationsSource, /手机确认已过期/);
  assert.match(translationsSource, /A phone opened an old entry/);
  assert.match(translationsSource, /The phone just opened an old entry/);
  assert.match(translationsSource, /generate a fresh QR code/);
  assert.match(translationsSource, /Waiting for phone confirmation/);
  assert.match(translationsSource, /Phone confirmed this entry/);
  assert.match(translationsSource, /Phone confirmation is stale/);
  ...
  const mobilePwaCapabilitiesCardSource = await readFile(path.join(rootDir, "src", "pages", "mobile", "MobilePwaCapabilitiesCard.tsx"), "utf8");
  ...
  assert.match(mobileDeviceSource, /icloudHandoffStatus/);
  assert.match(mobileDeviceSource, /currentEntryGuidance/);
  assert.match(mobileRemoteEntryCardSource, /icloudHandoffDesktopRepairRefreshed/);
  assert.match(mobileDeviceSource, /MobilePwaCapabilitiesCard/);
  assert.match(mobilePwaCapabilitiesCardSource, /mobileDevice\.pwaTitle/);
  assert.match(translationsSource, /PWA 安装与后台同步/);
  assert.match(mobilePwaCapabilitiesCardSource, /Service Worker/);
  assert.match(mobilePwaCapabilitiesCardSource, /Background Sync/);
  assert.match(mobilePwaCapabilitiesCardSource, /IndexedDB/);
  ...
  assert.match(mobilePwaCapabilitiesCardSource, /mobileDevice\.swLifecycle/);
  assert.match(mobilePwaCapabilitiesCardSource, /pwaCapabilities\.recommendations/);
  assert.match(mobilePwaCapabilitiesCardSource, /pwaRecommendationKey/);
  assert.match(mobilePwaCapabilitiesCardSource, /mobileDevice\.pwaRecommendation\.addToHome/);
  assert.match(mobilePwaCapabilitiesCardSource, /mobileDevice\.pwaRecommendation\.indexedDbUnavailable/);
  ...
  assert.match(mobileRemoteEntryCardSource, /mobileDevice\.icloudHandoffRecommendedEntryTitle/);
  assert.match(mobileRemoteEntryCardSource, /mobileDevice\.icloudHandoffRecommendedEntryBody/);
  assert.match(mobileRemoteEntryCardSource, /mobile-icloud-recommended-entry-only/);
  ...
  assert.match(mobileRemoteEntryCardSource, /mobileDevice\.icloudHandoffHideAdvancedEntries/);
  assert.match(mobileRemoteEntryCardSource, /mobileDevice\.icloudHandoffAdvancedEntriesTitle/);
  assert.match(mobileRemoteEntryCardSource, /mobileDevice\.icloudHandoffOtherAdvancedEntries/);
  assert.match(mobileRemoteEntryCardSource, /archivedIcloudEntries/);
  assert.match(mobileRemoteEntryCardSource, /mobile-icloud-advanced-entries/);
  ...
  assert.match(translationsSource, /日常只需要使用这个入口/);
  assert.match(translationsSource, /Use this entry for daily access/);
  assert.match(translationsSource, /高级：其他入口/);
  ...
  assert.match(mobileRemoteEntryCardSource, /autoSwitchedIcloudEntryReason/);
  assert.match(mobileRemoteEntryCardSource, /mobileDevice\.icloudHandoffAutoSwitchedReason/);
  ...
  assert.match(mobileRemoteEntryCardSource, /mobileDevice\.icloudHandoffHideAdvanced/);
  assert.match(mobileRemoteEntryCardSource, /mobileDevice\.icloudHandoffAdvancedTitle/);
  ...
  assert.match(translationsSource, /Expired/);
