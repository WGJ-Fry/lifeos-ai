...
test("production build serves desktop admin, mobile PWA, manifest, and service worker", async (t) => {
  ...
  assert.match(mobileDeviceSource, /MobileLastConnectivityCard/);
  assert.match(mobileDeviceSource, /refreshBusy=\{serverRefreshBusy\}/);
  assert.match(mobileDeviceSource, /retryBusy=\{connectivityBusy\}/);
