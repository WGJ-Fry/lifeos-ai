...
- Calendar/task sync history can now automatically roll back a completed Google Task or system Reminder by running a guarded update that restores the captured title, due time, notes, and unfinished status.
