...
- when signing variables are configured, `desktop:dist:mac` can produce `release/LifeOS AI-0.1.0-arm64.dmg`.
...
- Windows x64 NSIS succeeds and creates `release/LifeOS AI Setup 0.1.0.exe`.
- Linux x64 AppImage succeeds and creates `release/LifeOS AI-0.1.0.AppImage`.
