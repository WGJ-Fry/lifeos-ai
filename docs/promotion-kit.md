...
```text
LifeOS AI v0.1.4-alpha - Desktop core + mobile personal AI assistant
```

## Release 描述

```markdown
LifeOS AI v0.1.4-alpha is the first public desktop alpha with Docker quickstart plus macOS, Windows, and Linux desktop packages.
...
- Cold launch release: `https://github.com/WGJ-Fry/lifeos-ai/releases/tag/v0.1.4-alpha`
- Desktop package release: `https://github.com/WGJ-Fry/lifeos-ai/releases/tag/v0.1.4-alpha`
