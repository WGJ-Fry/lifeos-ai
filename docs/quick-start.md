...
| 系统 | 下载 |
| --- | --- |
| macOS Apple Silicon | `LifeOS.AI-0.1.5-alpha.0-arm64-unsigned.zip` |
| Windows x64 | `LifeOS.AI.Setup.0.1.5-alpha.0.exe` |
| Linux x64 | `LifeOS.AI-0.1.5-alpha.0.AppImage` |
...
请使用上面的 `v0.1.5-alpha` 直链；如果 GitHub 的 Latest release 标签显示旧版本，不要从旧版本下载。
...
Use the versioned `v0.1.5-alpha` link above; if GitHub's Latest release label shows an older build, do not download from the older release.
