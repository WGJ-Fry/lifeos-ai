...
打开 [GitHub Releases](https://github.com/WGJ-Fry/lifeos-ai/releases/tag/v0.1.4-alpha)，按系统下载：

| 系统 | 下载 |
| --- | --- |
| macOS Apple Silicon | `LifeOS.AI-0.1.4-alpha.0-arm64-unsigned.zip` |
| Windows x64 | `LifeOS.AI.Setup.0.1.4-alpha.0.exe` |
| Linux x64 | `LifeOS.AI-0.1.4-alpha.0.AppImage` |
...
请使用上面的 `v0.1.4-alpha` 直链；如果 GitHub 的 Latest release 标签显示旧版本，不要从旧版本下载。
...
Open [GitHub Releases](https://github.com/WGJ-Fry/lifeos-ai/releases/tag/v0.1.4-alpha) and download the file for your system:
...
Use the versioned `v0.1.4-alpha` link above; if GitHub's Latest release label shows an older build, do not download from the older release.
