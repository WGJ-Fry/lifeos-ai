...
function checkAssets() {
  ...
  if (
    ...
    onboardingAppleRemoteSource.includes("handleRunCloudKitSyncCycle") &&
    ...
    adminRoutesSource.includes("/api/v1/admin/icloud-data-sync/cycle") &&
    ...
    adminRoutesSource.includes("icloud_cloudkit_sync_cycle") &&
    ...
    lifeosApiSource.includes("CloudKitSyncApplyResult") &&
    ...
    lifeosApiSource.includes("CloudKitSyncCycleResult") &&
    ...
    cloudKitSyncBatchSource.includes("lifeos-cloudkit-sync-export.v1") &&
    cloudKitSyncBatchSource.includes("SYNC_APPROVED_RECORDS") &&
    ...
    cloudKitSyncBatchSource.includes("safeConversationTitleSnapshot") &&
    ...
    apiAuthTestSource.includes("/api/v1/admin/icloud-data-sync/cycle") &&
    apiAuthTestSource.includes("cloudKitSyncCycleNeedsSetup") &&
...
function checkReleaseDocs() {
  ...
  if (exists("docs/user-install-guide.md")) {
    ...
    const requiredUserGuideMarkers = [
      ...
      "Apple/iCloud 卡片",
      "Apple / iCloud Remote Entry",
      "same long-term acceptance records and diagnostic bundle",
